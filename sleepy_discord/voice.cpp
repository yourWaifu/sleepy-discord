...
namespace SleepyDiscord {
	...
	//VoiceState::VoiceState(const nonstd::string_view& rawJSON) : VoiceState(json::getValues(rawJSON.data(), fields)) {}

	//VoiceState::VoiceState(const json::Values values) :
	...
	//VoiceRegion::VoiceRegion(const nonstd::string_view& rawJSON) : VoiceRegion(json::getValues(rawJSON.data(), fields)) {}

	//VoiceRegion::VoiceRegion(const json::Values values) :
	//	//variable      modifier value               felid
	...
	//VoiceServerUpdate::VoiceServerUpdate(const nonstd::string_view& rawJSON) : VoiceServerUpdate(json::getValues(rawJSON.data(), fields)) {}

	//VoiceServerUpdate::VoiceServerUpdate(const json::Values values) :
